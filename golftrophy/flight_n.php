...
//$fli=$_POST['flight'];
   ...
   //echo "";
?>
<form name="fli_auswahl" action="flight_n.php" method="POST" OnSubmit>
...
<?php
   ...
   echo "<td>Name</td>";
   echo "<td>Ge</td>";
   echo "<td><strong>Nearest</strong></td>";
   ...
   for ($i=0; $i<$num; $i++)
   {
        ...
        echo "<td>$fc$na</td>";
        echo "<td>$fc$ge</td>";
        echo "<td align=center>$fc<a href='edit_nearest.php?ID=$id' border=0>$ne</a></td>";
        echo "<td align=center>$fc$lo</td>";
          // Tabellenzeile mit -zellen, wechselweise Grau hinterlegen
          if (($i % 2) !=1)
            {
            echo "</font>";
    ...
    if ($num == 0)
        {
        echo "<center><h4>Keine Daten zu Flight $fli gefunden!</h4></center>";
        }
    mysql_close($db);
?>
<hr>
