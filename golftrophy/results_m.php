...
<title> Golf Trophy - Ergebnis Herren</title>
</head>
<body>
    <script language=javascript>
     var TickerTime = 60000;
        function tickern()
   {
       location.href="results.php" ;
   }
...
//block 1
   $res = mysql_db_query("golfertrophy",
          "select id, flight, Name, geschlecht, Nearest + 0 as ne, longest from golfer where Geschlecht='M' AND Nearest+0>0 order by ne");
   $num = mysql_num_rows($res);

//block 2
   $res1 = mysql_db_query("golfertrophy",
          "select id, flight, Name, geschlecht, Nearest , longest + 0 as lo from golfer where Geschlecht='M' and longest+0>0 order by lo DESC");
   ...
   //echo "<h3>Herren, Nearest to Pin <small>$num Datensätze gefunden - </small>";
...
// Überschriftzeile block 1
   echo "<tr>";
   echo "<td COLSPAN=3>";
   echo "<strong><font size='+2'>Herren, Nearest to Pin </strong></font>";
   echo "</td><td></td>";
   echo "<td COLSPAN=3>";
   echo "<strong><font size='+2'>Herren, Longest Drive </strong></font>";
   echo "</td>";
   echo "</tr>";
   echo "</tr>";
   //echo "<td>id</td>";
